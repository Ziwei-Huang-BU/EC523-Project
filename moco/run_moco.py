#partial mostly cited from Momenmtum Encoder, Kaiming 
#!/usr/bin/env python
...
model_names = {'densenet169':  models.densenet169(pretrained=True)}

parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')
parser.add_argument('--data',  default='/projectnb/dl523/projects/COVIDCT2/dataset/LUNA/', type=str,
